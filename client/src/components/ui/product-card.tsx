...
export function ProductGridCard({
  ...
  return (
    <motion.div
      ...
      className={cn(
        'group relative flex flex-col rounded-2xl border border-border bg-card overflow-hidden transition-all duration-300 card-with-shine',
...
export function ProductListCard({
  ...
  return (
    <motion.div
      variants={productCardVariants}
      className={cn(
        'group flex flex-col sm:flex-row gap-4 rounded-2xl border border-border bg-card p-4 transition-all duration-300 card-with-shine',
