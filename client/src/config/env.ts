...
const env = {
  ...
  APP_NAME: import.meta.env.VITE_APP_NAME as string || 'Scientific Wala',
  APP_DESCRIPTION: import.meta.env.VITE_APP_DESCRIPTION as string || 'Innovation with Precision',
