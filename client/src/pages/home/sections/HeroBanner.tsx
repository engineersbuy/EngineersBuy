...
const fallbackBanners = [
  {
    _id: '1',
    title: 'Premium Lab Equipment',
    subtitle: 'Discover precision instruments, glassware, and research tools for your laboratory.',
    link: '/shop',
    gradient: 'from-slate-900 via-slate-800 to-slate-950',
  },
  {
    _id: '2',
    title: 'Lab Essentials Sale',
    subtitle: 'Up to 40% off on premium scientific instruments. Limited time offers on top brands.',
    link: '/deals',
    gradient: 'from-slate-900 via-slate-700 to-slate-900',
  },
  {
    _id: '3',
    title: 'Student Lab Kits',
    subtitle: 'Exclusive discounts for students. Lab kits, instruments, and chemicals at student-friendly prices.',
          ...
          >
            {slides ? (
              ...
              <div className={`relative h-full w-full bg-gradient-to-br ${fallbackBanners[current].gradient}`}>
                ...
                <div className="absolute bottom-0 left-1/3 w-64 h-64 rounded-full bg-teal-400/8 blur-[100px] pointer-events-none" />
                <div className="absolute inset-0 flex items-center">
                  <div className="container">
                    <div className="max-w-xl space-y-6">
                      <motion.div
                      ...
                      >
                        🔬 Scientific Wala Exclusive
                      </motion.div>
                      <motion.h2
                        initial={{ y: 30, opacity: 0 }}
                        animate={{ y: 0, opacity: 1 }}
                        transition={{ delay: 0.2, duration: 0.5 }}
                        className="text-display-lg sm:text-display-xl font-heading text-gradient-hero"
                      >
