        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <div className="relative z-10 space-y-4">
              ...
              <p className="text-body-md text-white/70 max-w-sm">
                Don't miss out on hourly rotating deals with up to 60% off on premium lab equipment.
              </p>
            </div>
          ...
          >
            ...
            <div className="relative z-10 space-y-4">
              ...
              <p className="text-body-md text-white/70 max-w-sm">
                Verify your student status and unlock exclusive discounts on lab equipment, instruments & more.
              </p>
            </div>
            <div className="relative z-10 mt-6">
              <Button asChild className="bg-white text-slate-900 hover:bg-white/90 group">
