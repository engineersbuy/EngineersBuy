...
export default function ReturnsPage() {
  return (
    <LegalLayout
      ...
      updated="30 May 2026"
      intro="We want you to be fully satisfied with your purchase. If something isn't right, here's how returns and refunds work at Scientific Wala."
    >
      ...
      <LegalSection heading="Non-returnable items">
        <p>
          ...
          consumable chemicals, opened reagent bottles, broken seals on sterile equipment and clearance-sale
      ...
      <LegalSection heading="How to request a return">
        <p>
          ...
          email scientificwalaindia@gmail.com with your order ID and reason. Our team will arrange a pickup or
      ...
      <LegalSection heading="Need help?">
        <p>
          For any return or refund query, reach out to scientificwalaindia@gmail.com and we'll be glad to assist.
        </p>
      </LegalSection>
    </LegalLayout>
  )
