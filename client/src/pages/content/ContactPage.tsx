...
const DETAILS = [
  { icon: Mail, label: 'Email us', value: 'scientificwalaindia@gmail.com', href: 'mailto:scientificwalaindia@gmail.com' },
  { icon: Phone, label: 'Call us', value: '+91-7051476988', href: 'tel:+917051476988' },
  {
    icon: MapPin,
    label: 'Visit us',
