...
export default function ShippingPage() {
  return (
    <LegalLayout
      ...
      updated="30 May 2026"
      intro="Here's everything you need to know about how and when your Scientific Wala order reaches you."
    >
      ...
      <LegalSection heading="Damaged or missing items">
        <p>
          ...
          scientificwalaindia@gmail.com within 48 hours of delivery with photos so we can resolve it quickly.
        </p>
      </LegalSection>
    </LegalLayout>
  )
