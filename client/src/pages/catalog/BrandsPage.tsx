    ...
    <div className="container py-6 lg:py-8">
      ...
      <div className="mb-8 rounded-3xl border border-border bg-gradient-to-br from-slate-50 to-card p-8 dark:from-slate-900/40 lg:p-12">
        <div className="flex items-center gap-3 text-primary">
          ...
          <span className="text-sm font-semibold uppercase tracking-wider">Trusted by scientists</span>
        </div>
        ...
        <p className="mt-2 max-w-xl text-body-md text-muted-foreground">
          From global scientific instrument manufacturers to specialist lab equipment makers — browse products
          from the brands researchers rely on.
        </p>
      </div>
