  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Scientific Royal Blue + Precision Gold Support Palettes
        brand: {
          50: '#eff6ff',
          100: '#dbeafe',
          200: '#bfdbfe',
      ...
      // ─── Shadows ────────────────────────────────────────────────────────
      boxShadow: {
        glow: '0 0 0 1px rgb(11 94 215 / 0.25)',
        'glow-lg': '0 0 0 2px rgb(11 94 215 / 0.2)',
        'glow-amber': '0 0 0 1px rgb(245 158 11 / 0.3)',
        'glow-cyan': '0 0 0 1px rgb(100 116 139 / 0.28)',
        card: '0 1px 2px rgb(15 23 42 / 0.06), 0 8px 24px -16px rgb(15 23 42 / 0.2)',
        'card-hover': '0 4px 12px rgb(11 94 215 / 0.1), 0 16px 32px -18px rgb(15 23 42 / 0.24)',
